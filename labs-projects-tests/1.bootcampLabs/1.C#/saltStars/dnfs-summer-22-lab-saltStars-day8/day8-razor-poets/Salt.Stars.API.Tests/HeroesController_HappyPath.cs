...
namespace Salt.Stars.API.Tests
{
  ...
  public class HeroesController_HappyPath
  {
    ...
    public HeroesController_HappyPath()
    {
      ...
      _starFileMock.Setup(fileClient => fileClient.GetStarsForHero(It.IsAny<int>()).Result).Returns(MOCK_NUMBER_STARS);

      this.controller = new HeroesController(_apiClientMock.Object, _starFileMock.Object);
    }
