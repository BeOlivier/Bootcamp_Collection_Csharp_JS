...
namespace Salt.Stars.Web.Pages
{
  ...
  {
    private readonly IGreetingAPIService _greetingAPIService;
    public IndexPage(IGreetingAPIService greetingAPIService) => _greetingAPIService = greetingAPIService;
    ...
    public async Task<IActionResult> OnGetAsync()
    {
      try
      {
        ...
        {
          Greeting = await _greetingAPIService.getGreeting(DeveloperName);
        }
      }
