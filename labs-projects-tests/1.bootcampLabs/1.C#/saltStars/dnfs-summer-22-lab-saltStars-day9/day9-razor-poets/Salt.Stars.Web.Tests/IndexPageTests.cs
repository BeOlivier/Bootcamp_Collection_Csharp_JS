...
namespace Salt.Stars.Web.Tests
{
  public class IndexPageTests
  {
    ...
    Mock<IGreetingAPIClient> _apiMockClient;
    public IndexPageTests()
    {
      _apiMockClient = new Mock<IGreetingAPIClient>();
      _apiMockClient.Setup(apiClient => apiClient.getGreeting(It.IsAny<string>()).Result).Returns(MOCK_RESPONSE);

      pageUnderTest = new IndexPage(_apiMockClient.Object);
    }
    ...
    async public void should_get_name()
    {
      ...
      // Assert
      _apiMockClient.Verify(p => p.getGreeting("APA"));
    ...
    async public void should_get_greeting()
    {
      ...
      // Assert
      _apiMockClient.Verify(p => p.getGreeting("BANAN"));
    ...
    {
      // Arrange
      _apiMockClient = new Mock<IGreetingAPIClient>(MockBehavior.Strict);
      _apiMockClient.Setup(apiService => apiService.getGreeting(It.IsAny<string>()).Result).Throws<Exception>();
      pageUnderTest = new IndexPage(_apiMockClient.Object);
