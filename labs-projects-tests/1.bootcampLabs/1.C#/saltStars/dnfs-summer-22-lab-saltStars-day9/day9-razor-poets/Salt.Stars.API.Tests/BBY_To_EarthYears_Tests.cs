...
namespace Salt.Stars.API.Tests
{
  ...
  public class BBY_To_EarthYears_Tests
  {
    ...
    {
      // act
      var earthBirthYear = ModelUtils.GetEarthBirthYear(birthYear);
    ...
    {
      // act
      var earthBirthYear = ModelUtils.GetEarthBirthYear(string.Empty);
    ...
    {
      // act
      var earthBirthYear = ModelUtils.GetEarthBirthYear("13425CRC");
